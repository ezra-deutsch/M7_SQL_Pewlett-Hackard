...
-- 7.3.2 Create new table for retiring employees
...
-- 7.3.4 Employee count by department number, add the Order By function, create new table retirement "dept_retirement"
SELECT COUNT(ce.emp_no), de.dept_no
